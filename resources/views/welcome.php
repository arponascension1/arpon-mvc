    ...
    <div class="container mx-auto px-4 py-12">
        <div class="flex flex-col items-center justify-center min-h-screen">
            <div class="text-center">
                <h1 class="text-5xl font-bold text-gray-900 mb-4">Welcome to Arpon MVC</h1>
                <p class="text-xl text-gray-600 mb-8">A lightweight and powerful PHP MVC framework.</p>
